                        ...
                        <div className="tp-slider-thumb-4  desk">
                            ...
                            <div className="tp-slider-thumb-4-shape">
                                ...
                                <div className="mbl-content">
                                    <h1>Elevate Your Style <br />with Every  Piece</h1>
                                    <p>Adorn jewels inspired by the royal <br /> jewellery adorned by empresss in maratha dynasty</p>
                                    <div className="exb-btn">
                                        <p>Exhibition & Sale <br /><span>of exquisite diamond jewellery</span></p>
                                    </div>
