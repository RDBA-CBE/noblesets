        ...
        >
          ...
          <div className="d-flex gap-3 mt-3 mt-md-0">
            <button
              ...
              title="Google"
              type="button"
              onClick={()=>router.push("https://www.threads.net/@noble_sets")}
            >
            ...
            <button
              ...
              title="Instagram"
              type="button"
              onClick={()=>router.push("https://www.instagram.com/noble_sets/")}
            >
            ...
            <button
              ...
              title="Facebook"
              type="button"
              onClick={()=>router.push("https://www.facebook.com/noblesets/")}
            >
            ...
            <button
              ...
              title="YouTube"
              type="button"
              onClick={()=>router.push("https://www.youtube.com/@noblesets")}
            >
