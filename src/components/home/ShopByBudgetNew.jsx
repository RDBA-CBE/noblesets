...
// ShopByBudget.jsx new buget difference
import React, { useEffect, useState } from "react";
import { useRouter } from "next/router";
import { useDispatch } from "react-redux";
import {
                        ...
                        <div className="col-md-6 col-sm-6">
                          <div className="sbb-card-1 cursor-pointer" onClick={() => handleBudgetClick(budgetItems[0])}>
                            <img
                              ...
                              alt="budget-1"
                            />
                            <div className="sbb-label">{budgetItems[0]?.label || "Under 20k"}</div>
                          </div>
                        </div>
                        ...
                        <div className="col-md-6 col-sm-6">
                          <div className="sbb-card-1 cursor-pointer" onClick={() => handleBudgetClick(budgetItems[1])}>
                            <img
                              ...
                              alt="budget-2"
                            />
                            <div className="sbb-label">{budgetItems[1]?.label || "Under 32k"}</div>
                          </div>
                        </div>
                      </div>
                    </div>
                        ...
                        <div className="col-md-6 col-sm-6">
                          <div className="sbb-card-2 cursor-pointer" onClick={() => handleBudgetClick(budgetItems[2])}>
                            <img
                              ...
                              alt="budget-3"
                            />
                            <div className="sbb-label">{budgetItems[2]?.label || "Under 44k"}</div>
                          </div>
                        </div>
                        <div className="col-md-6 col-sm-6">
                          <div className="sbb-card-2 cursor-pointer" onClick={() => handleBudgetClick(budgetItems[3])}>
                            <img
                              ...
                              alt="budget-4"
                            />
                            <div className="sbb-label">{budgetItems[3]?.label || "Under 30k"}</div>
                          </div>
                        </div>
                      </div>
                    </div>
