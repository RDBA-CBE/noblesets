...
const PrivacyPolicyMain = () => {
  return (
    <section
      className="tp-about-area pt-30 pb-30 legal-policies"
      ...
      <div className="container">
        ...
        <div>
          <p className="terms-para">
            ...
            <br /> Thank you for choosing to be part of our community M/s.
            Shivam Traders, doing business as NobleSets (“NobleSets”, “we”,
            ...
            personal information, please contact us at online@noblesets.com, or
            reach out to our Data Protection Officer at online@noblesets.com,
            whose contact details are listed at the end of this policy.
          </p>
          <p className="terms-para">
            {" "}
            The use of our Platform which includes Noblesets Mobile Application
            (hereinafter referred to as “Mobile Application/App”) and Internet
            pages of Noblesets Website – [www.noblesets.com] (hereinafter
            referred to as "Website") and our related Websites, platforms,
            Applications, Services, Products and content (together with the
            Mobile Application and Website, collectively referred to as
            ...
            or mobile application, processing of personal data could become
          ...
          <p className="terms-para">
            ...
            accordance with the Information Technology Act, 2000, Digital
            ...
            , Sensitive Personal Data or Information Rules, 2011, UAE Personal
            Data Protection Law (PDPL, 2021), California Consumer Privacy Act
            (CCPA){" "}
            <u>
              <a
                href="https://cppa.ca.gov/regulations/pdf/ccpa_statute.pdf"
                target="_blank"
              >
            ...
            <u>
              <a
                href="http://protection-data.ae/wp-content/uploads/2023/10/federal-decret-law-45-uae.pdf"
                target="_blank"
              >
                http://protection-data.ae/wp-content/uploads/2023/10/federal-decret-law-45-uae.pdf
              </a>
            </u>{" "}
            and The General Data Protection Regulation (GDPR){" "}
            <u>
              <a href="https://eur-lex.europa.eu/legal" target="_blank">
                https://eur-lex.europa.eu/legal
              </a>
            </u>{" "}
            applicable to Noblesets. By means of these data protection
            declarations, our enterprise would like to inform the general public
          ...
          <p className="terms-para">
            ...
            with, please discontinue use of our Sites or Apps and our services
            and/or you may disagree to provide any further information to us.
          </p>
          <p className="terms-para">
            This privacy policy applies to all information collected through our
            website (such as www.noblesets.com), mobile application, ("Apps"),
            chat applications like WhatsApp, social media accounts, email survey
            forms and/or any related services, sales, marketing or events (we
            refer to them collectively in this privacy policy as the
            "Services").
          </p>
          <p className="terms-para">
            <b>
              Please read this privacy & cookies policy carefully as it will
              help you make informed decisions about sharing your personal
              information with us.
            </b>
          </p>
          <b>
            IF YOU DO NOT AGREE WITH THE TERMS OF THIS PRIVACY & COOKIES POLICY,
            PLEASE DO NOT ACCESS THE WEBSITE/MOBILE APPLICATION.
          </b>
          <br />
          <br />
          ...
          <p className="terms-para">
            This Cookie Policy explains how NobleSets (“we”, “us”, or “our”)
            uses cookies and similar technologies to recognize you when you
            visit our website https://noblesets.com/ or mobile application
            (“Services”). It explains what these technologies are, why we use
          ...
          <ol>
            <li>
              ...
              <p className="terms-para">
                NobleSet uses cookies, tags and other technologies when you use
                any of the NobleSet websites, mobile sites or mobile apps
                (collectively "the services"). Cookies are used to ensure
                everyone has their best possible experience. Cookies also help
                ...
                stop using our site, or consult your browsing and third party
            ...
            <li>
              ...
              <p className="terms-para">
                ...
                the NobleSet servers. Cookies allow NobleSet to serve you better
                and more efficiently, and to personalize your experience on our
                site. Web beacons, tags and scripts may be used in the Websites
                or in emails to help us to deliver cookies, count visits,
                understand usage and campaign effectiveness and determine
                whether an email has been opened and acted upon. We may analyse
                or perform analysis based on the use of these technologies and
                generate reports on an individual and aggregated basis.
              </p>
              <p className="terms-para">
                Cookies can be "persistent" or "session" cookies. A persistent
                cookie helps us recognize you as an existing user, so it’s
                easier to return to NobleSet or interact with our services
                without signing in again. After you sign in, a persistent cookie
                stays in your browser and will be read by NobleSet when you
            ...
            <li>
              ...
              <p className="terms-para">
                ...
                and off the NobleSets site, and bring customized features to
                you. You can control the use of cookies at the individual
                browser level. If you elect not to activate the cookie or to
                later disable cookies, you may still visit our Websites, but
                your ability to use some features or areas of the Websites may
                be limited. We may use any of the following categories of
              ...
              >
                ...
                <tbody>
                  <tr>
                    ...
                    <td style={{ padding: "12px", border: "1px solid #ddd" }}>
                      Essential cookies (First Party Cookies) are sometimes
                      called "strictly necessary" as without them we cannot
                      provide many services that you need on the Website. For
                      example, essential cookies help remember your preferences
                      as you move around the Website. Essential cookies also
                      keep you logged in into a website. Without them the login
                  ...
                  <tr>
                    ...
                    <td style={{ padding: "12px", border: "1px solid #ddd" }}>
                      ...
                      NobleSets and partner websites so that we can make
                      improvements and report our performance. For example:
                      analyse visitor and user behaviour so as to provide more
                      relevant content or suggest certain activities. They
                  ...
                  <tr>
                    ...
                    <td style={{ padding: "12px", border: "1px solid #ddd" }}>
                      ...
                      NobleSets. These preferences are remembered, through the
                  ...
                  <tr>
                    ...
                    <td style={{ padding: "12px", border: "1px solid #ddd" }}>
                      ...
                      platforms or networks or NobleSets in order to, deliver
                      ads and track ad performance, enable advertising networks
                      to deliver ads that may be relevant to you based upon your
                      activities (this is sometimes called "behavioural"
                      "tracking" or "targeted" advertising) on the Websites.
                      They may subsequently use information about your visit to
                      target you with advertising that you may be interested in,
                      on NobleSets websites or other websites. For example,
                      these cookies remember which browsers have visited the
                      websites.
                    </td>
                  </tr>
                </tbody>
            ...
            <li>
              WHEN DOES NOBLESETS PLACE COOKIES?
              <p className="terms-para">
              ...
              <p className="terms-para">
                NobleSets may also have some cookies for its own analytics i.e.
                analytics not part of Google Analytics. Such cookies help
            ...
            <li>
              ...
              <p className="terms-para">
                ...
                Analytics, to use tracking technologies and remarketing services
                on the Website through first-party and third-party cookies.
                These technologies help us analyse and track users’ interactions
                with the Site, determine the popularity of certain content, and
                better understand online activity.
              </p>
              <p className="terms-para">
                By accessing the Website, you consent to the collection and use
                of your information by these third-party vendors. You are
                encouraged to review their privacy policies and contact them
                directly with any questions. We do not transfer personal
                information to these third-party vendors. If you do not want any
                information to be collected and used by tracking technologies,
                you can review the Google Analytics Privacy Policy or use the
                Network Advertising Initiative Opt-Out Tool or Digital
                Advertising Alliance Opt-Out Tool.
              </p>
              <p className="terms-para">
                Please note that getting a new computer, installing a new
                browser, upgrading an existing browser, or erasing or altering
                your browser’s cookies may also remove certain opt-out cookies,
                plug-ins, or settings.
              </p>
            </li>
            <li>
              WHAT THIRD-PARTY COOKIES DOES NOBLESET USE?
              <p className="terms-para">
              ...
              <p className="terms-para">
                ...
                cookie on the users' computer. This is the same process as if
                the user logs into these social networks directly.
              </p>
              <p className="terms-para">
                ...
                cookies, Google can tell us which pages our users view, which
                are most popular, what time of day our websites are visited,
                whether visitors have been to our websites before, what website
                referred the visitor to our websites, and other similar
                information. All of this information is anonymized.
              </p>
              <p className="terms-para">
                We suggest that you should check the respective privacy policies
                for these external services to help you understand what data
                these organizations hold about you and how they process it.
              </p>
              <ul>
                <li>
                  <a
            ...
            <li>
              ...
              <p className="terms-para">
                There are a number of ways you can manage what cookies are set
                on your devices. Essential cookies, however, cannot be disabled.
                If you do not allow certain cookies to be installed, the website
                may not be accessible to you and/or the performance, features,
                or services of the website may be compromised.
              </p>
              <p className="terms-para">
                You can also manage this type of cookie in the privacy settings
                on the web browser you are using. Please note that if you use
                your browser settings to block all cookies you may not be able
                to access parts of our or others' websites. Please see below for
                more information.
              </p>
              <p className="terms-para">
              ...
              <p className="terms-para">
                ...
                learn more about this feature from Google,{" "}
                <u>
                  <a
                ...
                . For further information about the Facebook Pixel,{" "}
                <u>
                  <a
          ...
          <ol>
            <li>
              ...
              <p className="terms-para">
                Noblesets collects Data for various purposes set out in this
                Privacy Notice. This Data includes, without limitation, the
                following categories:
              </p>
              <ol className="alphalist">
                <li>
                  Contact information: first and last name, email address,
                  postal address, country, employer, phone number and other
                  similar contact data.
                </li>
                <li>
                  Financial information: payment instrument information,
                  transactions, transaction history, preferences, method, mode
                  and manner of payment, spending pattern or trends, and other
                  similar data.
                </li>
                <li>
                ...
                <li>
                  ...
                  amount, transaction history and preferences and related
                  details.
                </li>
                <li>
                  Product and service information: Your account membership
                  number, registration and payment information, and
                  program-specific information, when you request products and/or
                  services directly from us, or participate in marketing
                  programs.
                </li>
                <li>
                  Personal information: Age, sex, date of birth, marital status,
                  nationality, details of government identification documents
                  provided, occupation, ethnicity, religion, travel history, or
                  any other personal information provided in responses to
                  surveys or questionnaires.
                </li>
                <li>
                  Personal data that is automatically collected when you use the
                  wearable device and connected application which may include
                  but is not limited to:
                  <ol type="i">
                    <li>
                      Data from sensors on the wearable device like heart rate,
                      steps taken, sleep duration, etc.
                    </li>
                    <li>
                      Schedule or appointments with health, fitness, wellness or
                      swimming coaches.
                    </li>
                    <li>
                      Your geographical location including GPS signals, cell
                      tower IDs and Wi-Fi access points.
                    </li>
                    <li>
                      Your usage information like IP address, bandwidth speed,
                      browser type, language, operating system, cookie
                      information, device or application identifier, standard
                      server log information, and information about the software
                      programs that are installed on your system.
                    </li>
                  </ol>
                </li>
                <li>
              ...
              <p className="terms-para">
                Your Contributions: Information and content, you provide. We
                collect the content, communications and other information you
                provide when you use our Services, including when you sign up
                for an account, create or share content, and message or
                communicate with others. This can include any information in or
                about the content (including without limitation, any text,
                information, graphics, messages, photos, images, location of a
                photo, the date a file was created), data, questions, comments,
                suggestions or other content, including personally identifiable
                information that you upload, send, email, display, perform,
                distribute, post or otherwise transmit to us, at our request or
                on your own, on, or through the Services, whether in connection
                with your use of the Services or through the use of any Third
                Party Websites or Third Party Services or otherwise, and whether
                publicly posted or privately transmitted.
              </p>
              <p className="terms-para">
                Your Messages: We store messages, photos, videos and documents
                from your chats on our servers so that you can access your chat
                data from any of your devices anytime without having to rely on
                third-party backups. All data is stored encrypted. Our
                developers do not access the user data.
              </p>
              <p className="terms-para">
                ...
                stored by insert payment partners names.
              </p>
              <p className="terms-para">
                Information automatically collected: Some information such as IP
                address and/or browser and device characteristics is collected
                automatically when you visit our Services or Apps.
              </p>
              <p className="terms-para">
                We automatically collect certain information when you visit, use
                or navigate the Services through our Apps or Website. This
                ...
                about how and when you use our Services or Apps and other
                technical information. This information is primarily needed to
                maintain the security and operation of our Services or Apps, and
              ...
              <p className="terms-para">
                Information collected through our App: We may collect
                information regarding your geo-location, mobile device, push
                notifications, when you use our apps. If you use our App, we may
              ...
              <ul>
                ...
                <li>
                  Mobile device’s storage to read & write videos, pictures & pdf
                  files from the device,
                </li>
                <li>
                  Contacts to find your connections who are already using our
                  services,
                </li>
                <li>Camera to capture images & videos to provide services,</li>
                <li>
                  Record Audio to capture audio while recording a video or live
                  video streaming,
                </li>
                <li>
                  If you wish to change any of our access or permissions, you
                  may do so in your device’s settings. However, revoking these
                  permissions may prevent you from using all or some of the
                ...
                <li>
                  Messages via messaging apps: We may request to send you
                  notifications via Whatsapp and/or other messaging apps. If you
                  wish to opt out from receiving communications on your chat
                  applications, you may decline/disagree when prompted on our
                  platform.
                </li>
              </ul>
            </li>
            <li>
              ...
              <p className="terms-para">
                We use personal information collected via our Services or Apps
              ...
              <ul>
                ...
                <li>
                  ...
                  and/or our third-party marketing partners, after taking
                  explicit consent from you, may use the personal information
                  you send to us such as name and email for our marketing
                ...
                <li>
                  To post testimonials: We post testimonials on our Services or
                  Apps that may contain personal information. Prior to posting a
                  testimonial, we will obtain your consent to use your name and
                  testimonial. If you wish to update, or delete your
                  testimonial, please contact us at online@noblesets.com and be
                  sure to include your name, testimonial location, and contact
                  information.
                </li>
                <li>
                  Request Feedback: We may use your information to request
                  feedback via calls/emails/survey tools and to contact you
                  about your use of our Services or Apps.
                </li>
                <li>
                ...
                <li>
                  For Marketing, Publicity & Promotions: Noblesets may also
                  publish User’s name, voice, likeness and other Personal
                  Information that is part of User’s User Content, and Noblesets
                  may use the content, or any portion of the content, for
                  advertising, marketing, publicity and promotional activities,
                  provided that Noblesets will not exercise such rights as to
                  any User Content which identifies User in a public manner
                  unless User provides a separate consent to Noblesets in
                  writing (email is sufficient) authorizing such use. For full
                  terms and conditions regarding User Content User submits to
                  the Service, please review Noblesets’s Terms & Conditions.
                </li>
                <li>
                  Noblesets or others may store, display, reproduce, publish,
                  distribute or otherwise use User Content online or offline in
                  any media or format (currently existing or hereafter
                  developed) and may or may not attribute it to User. Others may
                  have access to this User Content and may have the ability to
                  share it with third parties. Please think carefully before
                  deciding what information User shares, including Personal
                  Information, in connection with User’s User Content. Be aware
                  that public postings are not confidential. Please note that
                  Noblesets does not control who will have access to the
                  information that User chooses to make public and cannot ensure
                  that parties who have access to such publicly available
                  information will respect User’s privacy or keep it secure.
                  Noblesets is not responsible for the privacy or security of
                  any information that User makes publicly available on the
                  Service, the Mobile App or Website or what others do with
                  information User shares with them on the Mobile App and
                  Website. Noblesets is not responsible for the accuracy, use or
                  misuse of any User Content that User discloses or receives
                  from third parties through the Service.
                </li>
                <li>
                  ...
                  this information in aggregated and anonymized form so that it
            ...
            <li>
              ...
              <ul>
                <li>
                  Consent: We process your sensitive personal data or
                  information if you have given us specific consent to use it
              ...
              <ul>
                <li>
                  ...
                  that work including payment processing, data analysis, email
                  delivery, delivery partners, hosting services and marketing
                  ...
                  things, analyse and track data, determine the popularity of
                ...
                <li>
                  ...
                  perpetuity. If you interact with other users of the
                  Website/Mobile Application, those users may see your name,
                  profile photo, and descriptions of your activity, including
                  sending invitations to other users, chatting with other users,
                  liking posts, posting comments, posting reviews.
                </li>
                <li>
                  Online Postings: When you post comments, contributions or
                  other content to the Website/Mobile Application, your posts
                  may be viewed by all users and may be publicly distributed
                  outside the Website/Mobile Application in perpetuity.
                </li>
                <li>
                ...
                <li>
                  ...
                  companies to serve ads when you visit the Services or Apps.
                ...
                <li>
                  Third-party Websites: https://noblesets.com/ and Mobile
                  ...
                  have used these links to leave the Website/Mobile Application,
                  any information you provide to these third parties is not
                  ...
                  (if any) of the third party responsible for that website, and
            ...
            <li>
              ...
              <p className="terms-para">
                ...
                titled <b>"HOW CAN YOU CONTACT US ABOUT THIS NOTICE?".</b>
              </p>
              <ul>
                <li>
                ...
                <li>
                  ...
                  <ul>
                    <li>
                      ...
                      <a
                        href="https://www.paypal.com/us/privacy-center/home"
                        target="_blank"
                        rel="noopener noreferrer"
                      >
                        (GDPR Compliance)
                    ...
                    <li>
                      <a
                        href="https://www.upi.org/privacy-policy"
                        target="_blank"
                        rel="noopener noreferrer"
                      >
                        UPI (Privacy Policy)
            ...
            <li>
              ...
              <p className="terms-para">
                For information about our use of cookies and tracking
                technologies, please refer to our Cookie Policy, which is
                incorporated into this Privacy Policy.
              </p>
            </li>
            <li>
              ...
              <p className="terms-para">
                This website and mobile application uses Google Maps APIs. You
                may find the Google Maps APIs Terms of Service here. To better
            ...
            <li>
              ...
              <p className="terms-para">
                Our Services or Apps offer you the ability to register and login
                ...
                include your name, e-mail address, friends list, profile picture
              ...
              <p className="terms-para">
                ...
                made clear to you on the Services or Apps. Please note that we
            ...
            <li>
              ...
              <p className="terms-para">
                All web servers and hosting are managed by our team using Amazon
                Web Services in EU Region. This includes website hosting,
                backups, web database, file storage, APIs, and log files.
              ...
              <p className="terms-para">
                If you are accessing our Services or Apps from outside EU
                Region, please be aware that your information may be transferred
            ...
            <li>
              ...
              <p className="terms-para">
                We have implemented an appropriate Information Security
                Management System’s designed to protect the security of any
                personal information we process. We follow the best global
                practices. It is subject to strong controls including ongoing
                monitoring, periodic security testing, internal/external audits
                and verifications. However, please also remember that we cannot
                guarantee that the internet itself is 100% secure. Although we
                will do our best to protect your personal information,
                transmission of personal information to and from our Services or
            ...
            <li>
              ...
              <p className="terms-para">
                ...
                <u>
                  <a
                    ...
                    target="_blank"
                  >
                    https://www.protiviti.com/sites/default/files/202210/uae_personal_data_protection_law.pdf
                  </a>
                </u>
                , California Consumer Privacy Act (CCPA), Information Technology
                Act, 2000, Digital Personal Data Protection Act (DPDP Act,
                2023), Sensitive Personal Data or Information Rules, 2011, UAE
                ...
                2011 permits our users who are Indian residents and The General
                ...
                <u>
                  <a
                    ...
                    target="_blank"
                  >
                    https://pure.uva.nl/ws/files/34085945/European_Union_General_Data_Protection_Regulation.pdf
                  </a>
                </u>
                permits our users who are EU residents the right to review or
                amend the Sensitive Personal Data or Information (SPDI) and give
                the information provider an option to retract consent at any
                point of time, in relation to the information that has been so
                provided.
              </p>
              <p className="terms-para">
              ...
              <p className="terms-para">
                ...
                details here:{" "}
                <a
                  href="https://meity.gov.in/writereaddata/files/GSR313E_10511%281%29_0.pdf"
                  target="_blank"
                  rel="noopener noreferrer"
                >
              ...
              <p className="terms-para">
                Google forms: We also collect data through Google Forms and our
                surveys are designed to be anonymous. However, respondents
                should be aware that in responding to surveys, they could be
                disclosing information that could make them personally
                identifiable to Noblesets. Respondents to surveys should be
                aware that they alone are responsible for the content of their
                responses.
              </p>
              <p className="terms-para">
                We are specifically collecting information from our respondents
                so that we can better serve each of you and the Noblesets
                community as a whole. We map the feedback given by you through
                these surveys to our internal variables in order to enhance our
                services provided to you. This information is for our internal
                purposes only and will not be shared with outside parties
                without your consent. We do ensure that only authorised people
                within the organisation have access to the personal data
                harvested from Google Forms and they respect the company’s code
                of conduct regarding data protection.
              </p>
              <p className="terms-para">
                For more details on terms of use & privacy policy practices of
            ...
            <li>
              ...
              <p className="terms-para">
                ...
                with relevant laws. We may update this privacy policy from time
                ...
                policy, we may notify you either by prominently posting a policy
            ...
            <li>
              ...
              <p className="terms-para">
                ...
                online@noblesets.com, or by post to: M/s. Shivam traders
                <br />
                <p className="terms-para">
                  <b>Registered Office:</b> <br />
                  No. 78, New Market Street, Tiruppur – 641604, Tamil Nadu,
                  India{" "}
                </p>
                <p className="terms-para">
                  <b>Branch Offices at:</b>
                  <br />
                  <ol>
                    <li>
                      No. 96, New Market Street, Tiruppur-641604, Tamil Nadu,
                      India
                    </li>
                    <li>
                      {" "}
                      No. 33, Opp. Railway Station, Thangam Theatre Complex,
                      Madurai- 625001, Tamil Nadu, India
                    </li>
                    <li>
                      No. 65, Mengles Road, Dindigul – 624202, Tamil Nadu, India
                    </li>
                  </ol>
                </p>
              </p>
          ...
          <p className="terms-para">
            ...
            please email to online@noblesets.com. We will respond to your
