          ...
          {cart?.length > 0 && (
            <div className="row">
              <div className=" ">
                ...
                >
                  {!state.token && (
                    <div className="col-xl-7 col-lg-12 px-2" style={{borderRadius:"10px"}}>
                      <CheckoutLogin />
                    </div>
                  )}
                  <div
                                ...
                                <div className="col-md-12">
                                  <div className="tp-checkout-input">
                                    ...
                                    {state.errors.streetAddress2 && (
                                      <ErrorMsg
                                        msg={state.errors.streetAddress2}
                                      />
                                    )}
                                  </div>
                                </div>
                      ...
                      <ul className="list-unstyled">
                        ...
                        {state?.giftCard?.length > 0 &&
                          state?.giftCard?.map((item, i) => (
                            <li className="d-flex justify-content-between border-bottom py-2" key={i}>
                            ...
                            {state.selectedPaymentType == CASE_ON_DELIVERY && (
                              <ol>
                                ...
                                <li>
                                  ...
                                  for COD orders. Foreign currency cannot be
                                  used to make a COD payment.
                                </li>
                                <li>
                                  Cash on Delivery is not applicable on
                                  Pre-order products
                                </li>
                                <li>
